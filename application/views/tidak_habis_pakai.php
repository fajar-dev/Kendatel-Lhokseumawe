                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mt-4 activity">
                                    ...
                                    <input type="hidden" name="url" value="tidak_habis_pakai">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo htmlentities($data->merk, ENT_QUOTES, 'UTF-8');?></td>
                                                ...
                                                <td><?php echo htmlentities($data->stok_barang, ENT_QUOTES, 'UTF-8');?></td>
                                                    <td>
                                                        <a href="<?php echo base_url() ?>page/hapus/<?php echo $data->id_barang ?>/tidak_habis_pakai" class="btn btn-danger btn-del"><i class="fas fa-trash-alt"></i></a>
                                                    </td>
                                                <?php } ?>
                                            </tr>
                                    </table>
