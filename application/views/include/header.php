...
<head>
    ...
    <title>Kendatel - <?php echo $title ?></title>
    <!-- Custom CSS -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> 
                            ...
                            <li class="sidebar-item"> 
                            <a class="sidebar-link" href="<?php echo site_url() ?>page/Lokasi" aria-expanded="false">
                                <i data-feather="grid" class="feather-icon"></i><span class="hide-menu">Lokasi</span>
                            </a>
                            </li>
                            <li class="sidebar-item"> 
                                ...
                                <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                    <li class="sidebar-item">
                                        <a href="<?php echo site_url("page/habis_pakai") ?>" class="sidebar-link">
                                            <span class="hide-menu"> Habis Pakai</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a href="<?php echo site_url("page/tidak_habis_pakai") ?>" class="sidebar-link">
                                            <span class="hide-menu"> Tidak Habis Pakai</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">Kendatel Lhokseumawe
                                    </li>
                                </ol>
                            </nav>
                        </div>
